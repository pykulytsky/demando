"""verification_code field to user

Revision ID: dcee17a6aa3c
Revises:
Create Date: 2021-04-02 19:28:22.306150
...
def downgrade():
    ...
    sa.Column('pk', sa.INTEGER(), server_default=sa.text("nextval('polls_pk_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('pk', sa.INTEGER(), server_default=sa.text("nextval('questions_pk_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('pk', sa.INTEGER(), server_default=sa.text("nextval('options_pk_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False),
    ...
    sa.Column('pk', sa.INTEGER(), server_default=sa.text("nextval('users_pk_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('user_pk', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('question_pk', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['question_pk'], ['questions.pk'], name='user_likes_question_pk_fkey'),
    sa.ForeignKeyConstraint(['user_pk'], ['users.pk'], name='user_likes_user_pk_fkey')
    )
